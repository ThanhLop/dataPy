...
import os
import pandas as pd
from omformer2 import AisDK, AisNO, DMA
...
#sti til databasen
dbpath="sqlite:///AisDatabase.db" #sqlite:///\\streep\bredesager\RISK.REL\AISDatabase\AisDatabase.db
...
if __name__ == "__main__":
	...
	# Upload arguments
	parser.add_argument("-p", "--project", help="If mode==upload, specifies the project name of the directory to be uploaded. Spaces not allowed.", metavar="1234567890")
	...
	engine = create_engine(dbpath) #sqlite:///\\streep\bredesager\RISK.REL\AISDatabase\AisDatabase.db
